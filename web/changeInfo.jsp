                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="employeename" name="employeename" type="text" class="form-control"
                                       placeholder="输入姓名" maxlength="20"/>
                            </div>
                            <div class="form-group">
                                <label>学工号</label>
                                <input id="accountname" name="accountname" type="text" class="form-control"
                                       placeholder="输入学工号" maxlength="20"/>
                            </div>
                            <div class="form-group">
                                <label>所在部门</label>
                                <input id="departmentname" name="accountname" type="text" class="form-control"
                                       placeholder="输入部门" maxlength="20"/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
